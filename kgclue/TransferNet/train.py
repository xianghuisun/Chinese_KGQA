...
def main():
    ...
    # input and output
    parser.add_argument('--knowledge_dir', default = '/home/xhsun/Desktop/KG/kgCLUE/knowledge/small_knowledge', help='path to the KG')
    parser.add_argument('--qa_dir', default = '/home/xhsun/Desktop/KG/kgCLUE/qa_data', help='path to the data')
