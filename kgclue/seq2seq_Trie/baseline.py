...
# 模型路径
config_path = '/home/xhsun/NLP/huggingfaceModels/chinese_roformer-sim-char-ft_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/home/xhsun/NLP/huggingfaceModels/chinese_roformer-sim-char-ft_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '/home/xhsun/NLP/huggingfaceModels/chinese_roformer-sim-char-ft_L-12_H-768_A-12/vocab.txt'
...
# 转换知识库
KG = Trie()
if os.path.exists('/home/xhsun/NLP/KGQA/KG/kgCLUE/KG.json'):
    KG.load('/home/xhsun/NLP/KGQA/KG/kgCLUE/KG.json')
else:
    with open('/home/xhsun/NLP/KGQA/KG/kgCLUE/Knowledge.txt') as f:
        for l in tqdm(f):
            s, p, o = l.split('\t')
            s, m = subject_split(s)
            ...
            KG[ids] = ' '.join(o.split())
    KG.save('/home/xhsun/NLP/KGQA/KG/kgCLUE/KG.json')

# 读取数据集
train_data = load_data('/home/xhsun/NLP/KGQA/QApairs/Chinese/kgclue/train.json')
valid_data = load_data('/home/xhsun/NLP/KGQA/QApairs/Chinese/kgclue/dev.json')
test_data = load_data('/home/xhsun/NLP/KGQA/QApairs/Chinese/kgclue/test_public.json')

save_model_path='/home/xhsun/NLP/KGQA/model_save_dir/seq2seq_trie/best_model.weights'
...
if __name__ == '__main__':
    ...
    model.load_weights(save_model_path)
    test_predict('/home/xhsun/NLP/KGQA/QApairs/Chinese/kgclue/test.json', 'kgclue_predict.json', topk=3)
